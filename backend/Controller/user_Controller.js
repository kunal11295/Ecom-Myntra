import Myntras from "../Modal/userModal.js"
...
export const login = async (req,res) =>
{
    try{
        ...
        const response = await Myntras.findOne({email}).exec()
...
export const  getCurrentUser = async (req,res) => 
{
    ...
    try{
        ...
        const user = await Myntras.findById(userId)
        if(user)
        {
